...
def runAlgorithm():
    ...
    parser.add_argument('--pretrain_path2', type=str,
                        default='/data/jyz/scMCs/dae_scATAC.pkl')
    # parser.add_argument('--pretrain_path2', type=str,
    #                         default='/home/lrren/Single_cell_expermients/DSC-Net-master-pytorch/dae_zinb/SNARE/pre_train/dae_scATAC.pkl')

    params = parser.parse_args()
    data_root = "/data/jyz/dataset/Yc/Yc/"
    X1 = os.path.join(data_root, 'ATAC.csv')
    X2 = os.path.join(data_root, 'RNA.csv')
    x3 = os.path.join(data_root, 'labels.csv')
    #  params = parser.parse_args()
